...
RCSUBDIR="test"
HOST1="https://github.com/acutpay/acut/releases/download/v"
HOST2="https://pasta.keybase.pub/Acut-Core-Releases/"
BASEDIR=""
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Acut Core binary release signing key installed?"
   fi
