...
A prefix will be generated that's suitable for plugging into Acut's
configure. In the above example, a dir named x86_64-w64-mingw32 will be
created. To use it for Acut:
...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_acut` executable (see https://github.com/bitcoin/bitcoin/pull/13543),
...
options will be passed to Acut Core's configure. In this case, `--disable-wallet`.
