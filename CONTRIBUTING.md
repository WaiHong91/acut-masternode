Contributing to Acut Core
============================

The Acut Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/acutpay/acut/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
[Translation Process](https://github.com/acutpay/acut/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Acut Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Acut
Network Protocol consensus changes.

Whether a pull request is merged into Acut Core rests with the project merge
...
Patches that change Acut consensus rules are considerably more involved than
...
Where a patch set proposes to change the Acut consensus, it must have been
...
The review process is normally fairly responsive on the Acut Core repository, however
...
Bitcoin Backports are an incredibly valuable part of Acut's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for Acut](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each Acut Core release.
