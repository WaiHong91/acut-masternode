...
- Set the `self.setup_clean_chain` variable in `set_test_params()` to control whether
  ...
  has 25 mature blocks (25x500=12500 ACUT) in its wallet.
...
with the acutd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a acutd.  `P2PInterface`
...
Basic code to support P2P connectivity to a acutd.
