...
class LLMQCoinbaseCommitmentsTest(AcutTestFramework):
    def set_test_params(self):
        extra_args = [["-vbparams=dip0024:999999999999:999999999999"]] * 4 # disable dip0024
        self.set_acut_test_params(4, 3, extra_args=extra_args, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as AcutTestFramework doesn't support this atm)
