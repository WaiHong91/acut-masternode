...
"""Verify that starting acutd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start acutd with -h for help text")
        ...
        self.log.info("Start acutd with -version for version information")
        ...
        self.log.info("Start acutdd with -fakearg to make sure it does not start")
