...
foreverHidden(false)
{
    ...
    if (!enable_wallet) {
        ...
        ui->infoTextStrong->setText(tr("Acut Core is currently syncing.  It will download headers and blocks from peers and validate them until reaching the tip of the block chain."));
    }
}
