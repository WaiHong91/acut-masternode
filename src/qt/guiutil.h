...
/** Utility functions used by the Acut Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "acut:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load acut specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a acut specific theme is activated (light/dark).*/
