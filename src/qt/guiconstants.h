...
/* AcutGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* AcutGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Acut"
#define QAPP_ORG_DOMAIN "acut.org"
#define QAPP_APP_NAME_DEFAULT "Acut-Qt"
#define QAPP_APP_NAME_TESTNET "Acut-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Acut-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Acut-Qt-regtest"
