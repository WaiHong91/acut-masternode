...
//! Interface for the src/evo part of a acut node (acutd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a acut node (acutd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a acut node (acutd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a acut node (acutd process).
...
//! Top-level interface for a acut node (acutd process).
class Node
{
public:
    virtual ~Node() {}
