...
std::string ListLogCategories()
{
    ...
    for (const CLogCategoryDesc& category_desc : LogCategories) {
        ...
        if (category_desc.flag != BCLog::NONE && category_desc.flag != BCLog::ALL && category_desc.flag != BCLog::ACUT) {
            if (outcount != 0) ret += ", ";
...
std::string ListActiveLogCategoriesString()
{
    ...
    for (const CLogCategoryDesc& category_desc : LogCategories) {
        // Omit the special cases.
        if (category_desc.flag != BCLog::NONE && category_desc.flag != BCLog::ALL && category_desc.flag != BCLog::ACUT && LogAcceptCategory(category_desc.flag)) {
            if (outcount != 0) ret += ", ";
            ret += category_desc.category;
            outcount++;
        }
...
void BCLog::Logger::LogPrintStr(const std::string& str)
{
    ...
    if (m_log_threadnames && m_started_new_line) {
        // 16 chars total, "acut-" is 5 of them and another 1 is a NUL terminator
