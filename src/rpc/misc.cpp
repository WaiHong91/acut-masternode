...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"acut\" activates all Acut-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "acut")
    + HelpExampleRpc("debug", "acut+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given acut address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The acut address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The acut address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "acut-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Acut features */
    { "acut",               "mnsync",                 &mnsync,                 {} },
    { "acut",               "spork",                  &spork,                  {"command"} },
    { "acut",               "sporkupdate",            &sporkupdate,            {"name","value"} },
