 ...
 *  We have 4 times smaller block times in Acut, so we need to push 4 times more invs per 1MB. */
...
bool static AlreadyHave(const CInv& inv, const CTxMemPool& mempool, const LLMQContext& llmq_ctx) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
    ...
    /*
        Acut Related Inventory Messages
...
bool PeerLogicValidation::SendMessages(CNode* pto)
{
...

    {
        ...
        // ACUT this code also handles non-TXs (Acut specific messages)
