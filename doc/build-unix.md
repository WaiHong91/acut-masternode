UNIX BUILD NOTES
====================
Some notes on how to build Acut Core in Unix.
...
-----------------------
Building the dependencies and Acut Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your Acut Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Acut Core should be built with a non-executable stack,
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Acut Core may be compiled in
