...
This document provides guidelines for internationalization of the Acut Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `acut_en.ts` remains unchanged.
