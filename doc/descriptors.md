# Support for Output Descriptors in Acut Core

Since Acut Core v0.17, there is support for Output Descriptors. This is a
...
existing Acut Core wallets, a convenience function `combo` is
...
All RPCs in Acut Core will include the checksum in their output. Only
