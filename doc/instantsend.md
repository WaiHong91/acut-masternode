...
This mechanism has been integrated into Bitcore-Node-Acut which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/acutpay/insight-api-acut#web-socket-api](https://github.com/acutpay/insight-api-acut#web-socket-api)
* API: [https://github.com/acutpay/insight-api-acut#instantsend-transactions](https://github.com/acutpay/insight-api-acut#instantsend-transactions)
