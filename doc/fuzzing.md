# Fuzzing Acut Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Acut Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/acutpay/acut/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/acutpay/acut/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/acutpay/acut/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/acutpay/acut/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the Acut Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Acut Core more robust.
...
with certain assembly code from Acut Core's code. See [developer notes on sanitizers](https://github.com/acutpay/acut/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing Acut Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Acut Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Acut Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Acut Core using [Honggfuzz](https://github.com/google/honggfuzz):
